                ...
                jsonMapping.root.properties.PassiveEffectsProgressions_0?.Array.Struct.value.map(
                    (el) => [
                        el.Struct
                            ...
                            .Name,
                        el.Struct.IsLearnt_9_2561000E49D90653437DE9A45BE2A86D_0
                            .Bool,
                    ]
                ) || []
            ),
    ...
    const handlePictoCheckUpdate = (
        ...
        if (thisPictoWas!.mastered && !newMastered) {
            const currentArrPassEffectProg =
                jsonMapping.root.properties.PassiveEffectsProgressions_0.Array
                    .Struct.value
            ...
            if (passiveEffectsProgIndex !== -1) {
                ...
                ].Struct.LearntSteps_6_A14D681549E830249C77BD95F2B4CF3F_0.Int =
                    0
                newArr[
                    passiveEffectsProgIndex
                ].Struct.IsLearnt_9_2561000E49D90653437DE9A45BE2A86D_0.Bool =
                    false
            ...
            const currentArr =
                jsonMapping.root.properties.WeaponProgressions_0.Array.Struct
                    .value
            const index = currentArr.findIndex(
                (el) =>
                    el.Struct.DefinitionID_3_60EB24664894755B19F4EBA18A21AF1A_0
                        .Name === pictoName
            )
            if (index !== -1) {
                // Clone the array
        ...
        <div id="PictosPanel" className="tab-panel oveflow-auto">
            ...
            {displayedPictos.length != 0 && (
                <sup style={{ padding: '0.7em' }}>
                    {displayedPictos.length} results
                </sup>
            )}
            {/* Table */}
