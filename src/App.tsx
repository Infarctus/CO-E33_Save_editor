...
import {
    getMappingJsonFromFile,
    saveMappingJsonToDisk,
...
function App() {
    ...
    const [workingFileCurrent, setWorkingFileCurrent] =
        useState<OpenProcessResult | null>(null)
    ...
    const handleOpenFile = async () => {
        ...
        if (saveProcessResult.success) {
            ...
            if (saveProcessResult.tempJsonPath) {
                const mapping = await getMappingJsonFromFile(
                    saveProcessResult.tempJsonPath
                )
    ...
    const handleOverwriteFile = async () => {
        ...
        if (
            ...
            errorAndInfo(
                'No working file (original SAV path or temp JSON path) available.'
            )
            return
        }
